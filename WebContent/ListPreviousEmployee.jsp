...
<title>List All Previous Employee</title>
...
<sql:setDataSource
    ...
    <sql:query var="listEmployees" dataSource="${listDS}">
        SELECT * FROM timekeepersystem.employee WHERE currentEmployee=0 ORDER BY empId DESC;
    </sql:query>
...
<form>
<br>
<h1 align="center" style="color:#383b43"> List of all Previous Employees</h1><br>
